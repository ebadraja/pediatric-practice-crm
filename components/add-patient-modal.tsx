        ...
        <DialogContent className="w-full max-w-md">
          ...
          <div className="space-y-4 py-4">
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-6 flex flex-col items-center gap-3">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-emerald-700 mt-1">
                  has been added to your patient database
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-lg p-4 space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-slate-600">Parent/Guardian:</span>
                <span className="font-medium text-slate-900">{formData.parent}</span>
              </div>
              <div className="flex justify-between">
